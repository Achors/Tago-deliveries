...
class Authorization(Resource):
    ...
    def put(self, authorization_id):
        ...
        authorization.username = args['username'] or authorization.username
...
class Authorizations(Resource):
    ...
    def post(self):
        ...
        new_authorization = Authorization(user_id=args['user_id'], username=args['username'], last_login=args['last_login'])
